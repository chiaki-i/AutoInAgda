...
open import Reflection   using (Name; Term; TC; inferType; quoteTC; unify) renaming (bindTC to _>>=_)
...
macro
  ...
  auto depth hintdb = runTacT (λ h → inferType h >>= (λ t → auto′ dfs depth hintdb t))
